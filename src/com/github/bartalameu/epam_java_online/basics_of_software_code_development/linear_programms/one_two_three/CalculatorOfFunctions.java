...
*/
public class CalculatorOfFunctions {
    ...
    public static String first_equation() {
        ...
        scan.close();
        FirstFunction first = new FirstFunction(a, b, c);
        first.calcul_func();
    ...
    public static String second_equation() {
        ...
        sc.close();
        SecondFunction second = new SecondFunction(a, b, c);
        second.calcul_func();
    ...
    public static String third_equation() {
        ...
        sc.close();
        ThirdFunction third = new ThirdFunction(x, y);
        third.calcul_func();
